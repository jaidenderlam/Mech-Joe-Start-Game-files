...
// scores bar
 ...
 // distance
    shapes.font = "bold 180% Times New Roman";
    shapes.fillStyle = "red";
    shapes.fillText("Distance: " + distances.toFixed(0) + " m",c.width/2 - 250 ,c.height*0.93);
    shapes.fillText("Best Distance: " + bestDistance.toFixed(0)+ " m", c.width/2 +40, c.height*0.93);
